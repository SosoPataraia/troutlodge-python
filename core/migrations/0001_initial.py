...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ploidy', models.CharField(choices=[('diploid', 'Diploid'), ('triploid', 'Triploid')], max_length=10)),
                ('type', models.CharField(choices=[('steelhead', 'Steelhead'), ('jumper', 'Jumper'), ('kamloop', 'Kamloop')], max_length=10)),
                ('diameter', models.IntegerField(choices=[(4, '4mm'), (5, '5mm'), (6, '6mm')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('sales', 'Sales Team'), ('hatchery', 'Hatchery Management'), ('customer', 'Customer')], max_length=10)),
